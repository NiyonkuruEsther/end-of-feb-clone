    ...
    <div className="pb-20 pt-10 md:py-16 text-white">
      <Wrapper styles={`pb-6 gap-3 flex flex-col`}>
        ...
        <div className="flex justify-between">
          ...
          <button className="border hover:border-lightBlue hover:bg-lightBlue hover:text-white md:block hidden border-white rounded-full px-6 ">
            See all events
          </button>
        </div>
        <p className="text-xl">
      ...
      <div className=" flex flex-col gap-3 md:-space-y-5">
        ...
        />
        <button className="md:hidden hover:border-lightBlue mx-5 py-2 hover:bg-lightBlue hover:text-white flex flex-col items-center border border-white rounded-full w-fit px-6 ">
          Lorem text here
        </button>
      </div>
    </div>
