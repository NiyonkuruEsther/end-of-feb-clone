    ...
    <div className="pt-24 md:pb-20 pb-16 text-white">
      <Wrapper styles={` pb-6 gap-3 flex flex-col`}>
        <div className="flex justify-between">
          ...
          <button className="hidden md:block border border-white rounded-full px-6 ">
            Lorem text here
          </button>
        </div>
        <p className="text-xl">
      ...
      <div className="flex flex-col gap-3 md:-space-y-12">
        ...
        />
        <button className=" md:hidden mx-5 py-2 flex flex-col items-center border border-white rounded-full px-6 w-fit">
          Lorem text here
        </button>
      </div>
    </div>
