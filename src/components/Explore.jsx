...
const Explore = () => {
  return (
    <>
      {/* mobile */}
      <div className="  lg:hidden h-96 mb-56 lg:py-24 lg:mb-32 mt-16 bg-center bg-[url('https://www.aalto.fi/sites/g/files/flghsv161/files/styles/s2560wc_1800w_400h_n/public/2020-01/unto_rautio_aalto_dsc5557_web.jpg?itok=vZ292N9N')]">
      ...
      {/* desktop */}
      <div className="h-96 hidden lg:block py-24 mb-12 bg-[url('https://www.aalto.fi/sites/g/files/flghsv161/files/styles/s2560wc_1800w_400h_n/public/2020-01/unto_rautio_aalto_dsc5557_web.jpg?itok=vZ292N9N')]">
        <Wrapper styles=" py-20 relative ">
          <div className=" max-w-6xl w-full overflow-hidden bg-lightBlue h-72 mx-auto">
            ...
            <div className="border-t text-white grid grid-cols-3 justify-items-center overflow-hidden">
              ...
              <div className="border-x px-20 py-9">
                <Link
                  href={"/"}
                  className="underline text-2xl whitespace-nowrap hover:bg-white hover:text-black"
                >
                  Study at Aalto
                </Link>
              </div>
