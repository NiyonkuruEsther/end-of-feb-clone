...
const Footer = () => {
  return (
    <div className={"border-t border-white w-full"}>
      {" "}
      <Wrapper styles=" bg-mediumGray text-white lg:px-0 px-5 md:px-12 py-10 relative z-30">
        <div className=" grid space-y-12 xl:space-y-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 pb-10 ">
          <div className="text-lg">
            <Link href={"/"} className="inline-flex pb-10">
              <div className="group flex flex-col justify-center max-w-fit items-center">
                ...
                <h4 className={`text-xs font-medium `}>Aalto University</h4>
              </div>
            </Link>
              ...
              {[
                ...
                return (
                  <Link
                    key={item}
                    href="/"
                    className="block text-base w-fit underline hover:bg-neutral-700"
                  >
                    {" "}
                    {item}
                  </Link>
          ...
          <div className="space-y-7 xl:border-t lg:order-last md:border-none w-fit max-w-fit pt-5 md:pt-0 lg:whitespace-nowrap xl:whitespace-normal ">
            ...
            <button
              className={
                "bg-white inline-flex hover:border-lightBlue hover:bg-lightBlue hover:text-white text-black rounded-full py-2 px-5 whitespace-nowrap"
              }
            >
          ...
          <div className=" mt-10 md:mt-0 md:flex gap-5 space-y-3 md:space-y-0">
            {["Suomeksi", "Svenska", "English"].map((item, index) => (
              <Link
                key={item}
                href="/"
                className={`block text-base w-fit underline ${
